...
class SleepAi extends StatefulWidget {
  const SleepAi({super.key});

  @override
  State<SleepAi> createState() => _SleepAiState();
}

class _SleepAiState extends State<SleepAi> {
              ...
              BoxShadow(
                ...
                offset: Offset(0, 10),
                    ...
                    child: SizedBox(
                      ...
                      child: Lottie.asset(
              'assets/animations/sleeping1.json',
              fit: BoxFit.cover,
                      ),
                    ),
                  ),
