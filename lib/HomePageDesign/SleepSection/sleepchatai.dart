...
class SleepChatAi extends StatefulWidget {
  const SleepChatAi({super.key});

  @override
  State<SleepChatAi> createState() => _SleepChatAiState();
}

class _SleepChatAiState extends State<SleepChatAi> {
  
  // List to hold chat messages (sender, text, timestamp)
  final List<Map<String, dynamic>> _messages = [
    {
      "sender": "bot",
     "text": "Hi! I'm your sleep assistant. How can I help you tonight?",
      "time": DateTime.now(),
    },
  ];
      ...
      body: Container(
        ...
        child: Column(
          ...
          child: Wrap(
            spacing: 8,
            runSpacing: 10,
            children: _suggestionPropmts.map((propmpt){
            return ActionChip(
              label: Text(propmpt),
